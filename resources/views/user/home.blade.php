                ...
                <div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('customer/img/pos-banner1.jpg') }}" class="d-block w-100" alt="Modern POS Payment Terminal">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Secure Payment Processing</h5>
                                <p>Accept contactless payments with ease</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('customer/img/pos-banner2.jpg') }}" class="d-block w-100" alt="Mobile Payment Solutions">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Mobile & Card Payments</h5>
                                <p>Pay with your phone or card, anytime</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('customer/img/pos-banner3.jpg') }}" class="d-block w-100" alt="Professional POS System">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Professional POS System</h5>
